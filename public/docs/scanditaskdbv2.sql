...
CREATE TABLE `dvd` (
  `id` int(11) UNSIGNED NOT NULL,
  `product_type` char(10) NOT NULL DEFAULT 'DVD' CHECK (`product_type` = 'DVD'),
...
CREATE TABLE `products` (
  ...
  `product_type` char(10) NOT NULL CHECK (`product_type` in ('DVD','Book','Furniture'))
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(12, 'hhf-dhdg-fjjf', 'ntech-dvd', '80.00', 'DVD'),
